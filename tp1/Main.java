...
public class Main {
    ...
    public static MySimpleLinkedList<Integer> getElementosComunesListasOrdenadas(MySimpleLinkedList<Integer> lista1, MySimpleLinkedList<Integer> lista2) {
    ...
    public static MySimpleLinkedList<Integer> getElementosNoComunesListasDesordenadas(MySimpleLinkedList<Integer> lista1, MySimpleLinkedList<Integer> lista2) {
    ...
    // Metodo para llenar lista desordenada
